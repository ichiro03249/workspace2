...
//~ ←チルダという名前らしい　ホームディレクトリ
//ルートディレクトリ　ディレクトリの中での頂点の場所　その下がホームディレクトリ
//mkdir 新しいフォルダのlコマンド　make directry
//mkdir -p test/smalltest -pをつけることで子フォルダも作ることができる
//ls -a すべてのファイル・ディレクトリと表示する　allのaだろう
//ls -l ファイルの詳細を表示する
//ls -S ファイルサイズが大きい順に並べ変えて表示する
//
//ファイルオーナーが一番強い
//グループが２番目
//その他が下
//
//実行ってのはディレクトリとかだと中に入るというやつ　実行するやつなら実行できる　エグゼとか
//ファイルとかだとあんまり意味はないのかも　読み書きができるならそれでいいパターンのやつだから
//
//.がカレントディレクトリ
//..が一つ上のディレクトリ
//　/がルートディレクトリ
//.tstとかだこの.は隠しファイルを意味する
//
//viエディタ
//writtenが保存完了のサイン
//
...
//-iでいいかどうか問い合わせてくれる
//-r　ディレクトリを削除してくれる
//-d ディレクトリごと削除してくれる。スーパーユーザーだけが使える
//-r -R　ディレクトリを再帰的に削除する
//
//shutdown -h nowでシャットダウンになり、CentOSはシステムの停止になる
//
//---------------5限目----------------
//rootで入るとホームディレクトリがホームディレクトリではなくてrootになっている
//でも、その親はroot　だから別もんってことだろうね
//homeの中に一般ユーザーが入ってる
//rootユーザーはrootに入ってるという意味
//ユーザーによってホームディレクトリが違うよという話
//
//
//
//
